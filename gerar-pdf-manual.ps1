# gerar-pdf-manual.ps1
Write-Host "📄 Gerando Manual do Usuário..." -ForegroundColor Green
...
2. A busca acontece em tempo real
...
2. Visualize, cadastre, edite ou exclua localidades

**PSFs (Unidades de Saúde):**
1. Clique em "PSFs" no menu lateral
2. Visualize, cadastre, edite ou exclua PSFs
...
- **Excel:** Arquivo nativo do Excel (.xlsx)
- **PDF:** Documento em PDF para impressão
...
**Quem pode gerenciar:** Apenas administradores
...
$conteudo | Out-File -FilePath MANUAL_USUARIO.md -Encoding UTF8

Write-Host ""
Write-Host "✅ Manual criado em MANUAL_USUARIO.md" -ForegroundColor Green
Write-Host ""
Write-Host "📄 Para converter para PDF:" -ForegroundColor Yellow
Write-Host "   1. Instale o Pandoc: https://pandoc.org/installing.html" -ForegroundColor Yellow
Write-Host "   2. Execute: pandoc MANUAL_USUARIO.md -o MANUAL_USUARIO.pdf" -ForegroundColor Yellow
Write-Host ""
Write-Host "📄 OU use um site online:" -ForegroundColor Yellow
